  ...
  <Layout  title="Works">
    ...
    <Box borderRadius="lg" bg="#0e151a" p={10} w={"100%"} mh={"50vh"} mt={36} align="center">  
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section delay={0.1}>
          <WorkGridItem pb={2} id="dystopia" title="Dystopia" priority={true} thumbnail={prevDystopia} >
        ...
        <Section delay={0.1}>
          <WorkGridItem pb={2} id="dashboard" title="Moby-Dashboard" priority={true} thumbnail={mbd}>
        ...
        <Section delay={0.3}>
          <WorkGridItem pb={2} id="car-chain" title="Car Rental Dapp" priority={true} thumbnail={car}>
        ...
        <Section delay={0.1}>
          <WorkGridItem pb={2} id="nft-scroller" title="NFT-Scroller" priority={true} thumbnail={nftscroller}>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section delay={0.1}>
          <WorkGridItem pb={2} id="dys-contract" title="Dystopia Contract" priority={true} thumbnail={dyscontract}>
        ...
        <Section delay={0.1}>
          <WorkGridItem pb={2} id="remillioMaker" title="Remillio Contract" priority={true} thumbnail={remcontract}>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section delay={0.1}>
          <WorkGridItem pb={2} id="seattle" title="Seattle Space Needle" priority={true} thumbnail={seattle}>
        ...
        <Section delay={0.1}>
          <WorkGridItem pb={2} id="gueira" title="Gueira's Helmet" priority={true} thumbnail={helmet}>
